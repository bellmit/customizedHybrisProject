...
public class CategoryModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Category.slvCategoryCustomField</code> attribute defined at extension <code>solviacore</code>. */
	public static final String SLVCATEGORYCUSTOMFIELD = "slvCategoryCustomField";
	
	/** <i>Generated constant</i> - Attribute key of <code>Category.slvCategoryCustomFieldInteger</code> attribute defined at extension <code>solviacore</code>. */
	public static final String SLVCATEGORYCUSTOMFIELDINTEGER = "slvCategoryCustomFieldInteger";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Category.slvCategoryCustomField</code> attribute defined at extension <code>solviacore</code>. 
	 * @return the slvCategoryCustomField
	 */
	@Accessor(qualifier = "slvCategoryCustomField", type = Accessor.Type.GETTER)
	public String getSlvCategoryCustomField()
	{
		return getPersistenceContext().getPropertyValue(SLVCATEGORYCUSTOMFIELD);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Category.slvCategoryCustomFieldInteger</code> attribute defined at extension <code>solviacore</code>. 
	 * @return the slvCategoryCustomFieldInteger
	 */
	@Accessor(qualifier = "slvCategoryCustomFieldInteger", type = Accessor.Type.GETTER)
	public Integer getSlvCategoryCustomFieldInteger()
	{
		return getPersistenceContext().getPropertyValue(SLVCATEGORYCUSTOMFIELDINTEGER);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Category.slvCategoryCustomField</code> attribute defined at extension <code>solviacore</code>. 
	 *  
	 * @param value the slvCategoryCustomField
	 */
	@Accessor(qualifier = "slvCategoryCustomField", type = Accessor.Type.SETTER)
	public void setSlvCategoryCustomField(final String value)
	{
		getPersistenceContext().setPropertyValue(SLVCATEGORYCUSTOMFIELD, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Category.slvCategoryCustomFieldInteger</code> attribute defined at extension <code>solviacore</code>. 
	 *  
	 * @param value the slvCategoryCustomFieldInteger
	 */
	@Accessor(qualifier = "slvCategoryCustomFieldInteger", type = Accessor.Type.SETTER)
	public void setSlvCategoryCustomFieldInteger(final Integer value)
	{
		getPersistenceContext().setPropertyValue(SLVCATEGORYCUSTOMFIELDINTEGER, value);
	}
