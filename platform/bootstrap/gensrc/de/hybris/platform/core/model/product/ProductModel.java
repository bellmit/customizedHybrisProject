...
public class ProductModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.slvProductCustomField</code> attribute defined at extension <code>solviacore</code>. */
	public static final String SLVPRODUCTCUSTOMFIELD = "slvProductCustomField";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.slvProductCustomFieldInteger</code> attribute defined at extension <code>solviacore</code>. */
	public static final String SLVPRODUCTCUSTOMFIELDINTEGER = "slvProductCustomFieldInteger";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.slvProductCustomField</code> attribute defined at extension <code>solviacore</code>. 
	 * @return the slvProductCustomField
	 */
	@Accessor(qualifier = "slvProductCustomField", type = Accessor.Type.GETTER)
	public String getSlvProductCustomField()
	{
		return getPersistenceContext().getPropertyValue(SLVPRODUCTCUSTOMFIELD);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.slvProductCustomFieldInteger</code> attribute defined at extension <code>solviacore</code>. 
	 * @return the slvProductCustomFieldInteger
	 */
	@Accessor(qualifier = "slvProductCustomFieldInteger", type = Accessor.Type.GETTER)
	public Integer getSlvProductCustomFieldInteger()
	{
		return getPersistenceContext().getPropertyValue(SLVPRODUCTCUSTOMFIELDINTEGER);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.slvProductCustomField</code> attribute defined at extension <code>solviacore</code>. 
	 *  
	 * @param value the slvProductCustomField
	 */
	@Accessor(qualifier = "slvProductCustomField", type = Accessor.Type.SETTER)
	public void setSlvProductCustomField(final String value)
	{
		getPersistenceContext().setPropertyValue(SLVPRODUCTCUSTOMFIELD, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Product.slvProductCustomFieldInteger</code> attribute defined at extension <code>solviacore</code>. 
	 *  
	 * @param value the slvProductCustomFieldInteger
	 */
	@Accessor(qualifier = "slvProductCustomFieldInteger", type = Accessor.Type.SETTER)
	public void setSlvProductCustomFieldInteger(final Integer value)
	{
		getPersistenceContext().setPropertyValue(SLVPRODUCTCUSTOMFIELDINTEGER, value);
	}
