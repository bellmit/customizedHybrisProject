...
import com.solvia.facades.product.data.GenderData;
...
public  class ProductData  implements Serializable 
{
	...
	/** <i>Generated property</i> for <code>ProductData.firstVariantCode</code> property defined at extension <code>b2boccaddon</code>. */
		
	private String firstVariantCode;

	/** <i>Generated property</i> for <code>ProductData.firstVariantImage</code> property defined at extension <code>b2boccaddon</code>. */
		
	private String firstVariantImage;

	/** <i>Generated property</i> for <code>ProductData.genders</code> property defined at extension <code>solviafacades</code>. */
		
	private List<GenderData> genders;

	/** <i>Generated property</i> for <code>ProductData.slvProductCustomField</code> property defined at extension <code>solviafacades</code>. */
		
	private String slvProductCustomField;

	/** <i>Generated property</i> for <code>ProductData.slvProductCustomFieldInteger</code> property defined at extension <code>solviafacades</code>. */
		
	private Integer slvProductCustomFieldInteger;
	...
	public void setSlvProductCustomField(final String slvProductCustomField)
	{
		this.slvProductCustomField = slvProductCustomField;
	}

	public String getSlvProductCustomField() 
	{
		return slvProductCustomField;
	}
	
	public void setSlvProductCustomFieldInteger(final Integer slvProductCustomFieldInteger)
	{
		this.slvProductCustomFieldInteger = slvProductCustomFieldInteger;
	}

	public Integer getSlvProductCustomFieldInteger() 
	{
		return slvProductCustomFieldInteger;
	}
