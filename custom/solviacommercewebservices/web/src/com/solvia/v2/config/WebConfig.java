 ...
 */
package com.solvia.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.solvia.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "solviacommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "solviacommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "solviacommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "solviacommercewebservices.v2.description";
	private static final String TITLE = "solviacommercewebservices.v2.title";
	private static final String VERSION = "solviacommercewebservices.v2.version";
	private static final String LICENSE = "solviacommercewebservices.v2.license";
	private static final String LICENSE_URL = "solviacommercewebservices.v2.license.url";
