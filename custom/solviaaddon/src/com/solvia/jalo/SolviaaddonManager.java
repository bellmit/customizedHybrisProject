...
import com.solvia.constants.SolviaaddonConstants;



/**
 * This is the extension manager of the Solviaaddon extension.
 */
public class SolviaaddonManager extends GeneratedSolviaaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SolviaaddonManager.class.getName());
	 ...
	 */
	public static SolviaaddonManager getInstance()
	{
		return (SolviaaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SolviaaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolviaaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SolviaaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SolviaaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SolviaaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
