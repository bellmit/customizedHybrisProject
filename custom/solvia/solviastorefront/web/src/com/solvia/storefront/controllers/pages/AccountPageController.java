 ...
 */
package com.solvia.storefront.controllers.pages;

import com.solvia.storefront.form.SlvUpdateProfileForm;
...
import com.solvia.storefront.controllers.ControllerConstants;
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	/*
	@Resource(name = "slvCustomerFacade")
	...
	public String editProfile(final Model model) throws CMSItemNotFoundException
	{
		...
		final CustomerData customerData = customerFacade.getCurrentCustomer();
		final SlvUpdateProfileForm updateProfileForm = new SlvUpdateProfileForm();
		...
		//Oguz Edit
		updateProfileForm.setSlvCustomField(customerData.getSolviaCustomField());
		updateProfileForm.setSlvCustomFieldInteger(customerData.getSolviaCustomFieldInteger());
	...
	@RequireHardLogIn
	public String updateProfile(final SlvUpdateProfileForm updateProfileForm, final BindingResult bindingResult, final Model model,
								final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		//Oguz Edit
		customerData.setSolviaCustomField(updateProfileForm.getSlvCustomField());
		customerData.setSolviaCustomFieldInteger(updateProfileForm.getSlvCustomFieldInteger());
