...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/solviastorefront/electronics/en",
						"https://electronics.local:9002/solviastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/solviastorefront/electronics/en",
						"https://electronics.local:9002/solviastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/solviastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/solviastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/solviastorefront/electronics/en",
						"https://electronics.local:9002/solviastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/solviastorefront",
						"https://electronics.local:9002/solviastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/solviastorefront",
						"https://electronics.local:9002/solviastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/solviastorefront/electronics/en",
						"https://electronics.local:9002/solviastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
