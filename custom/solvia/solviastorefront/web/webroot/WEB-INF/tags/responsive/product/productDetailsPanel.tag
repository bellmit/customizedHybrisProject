...
<div class="product-details page-title">
	<ycommerce:testId code="productDetails_productNamePrice_label_${product.code}">
		...
		<div class="name">${fn:escapeXml(product.slvProductCustomField)}<span class="sku">ID</span><span class="code">${fn:escapeXml(product.slvProductCustomFieldInteger)}</span></div>
