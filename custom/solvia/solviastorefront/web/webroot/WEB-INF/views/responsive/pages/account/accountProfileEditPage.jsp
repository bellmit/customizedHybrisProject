        ...
        <div class="account-section-content">
            <div class="account-section-form">
                <form:form action="update-profile" method="post" modelAttribute="updateProfileForm">
                    ...
                    <%-- Oguz's Edit --%>
                    <formElement:formInputBox idKey="profile.slvCustomField" labelKey="profile.slvCustomField" path="slvCustomField" inputCSS="text"/>
                    <formElement:formInputBox idKey="profile.slvCustomFieldInteger" labelKey="profile.slvCustomFieldInteger" path="slvCustomFieldInteger" inputCSS="text"/>
