...
import com.solvia.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/solviafulfilmentprocess/test/solviafulfilmentprocess-spring-test.xml"));
		...
		definitonFactory.add("classpath:/solviafulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/solviafulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/solviafulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/solviafulfilmentprocess/test/solviafulfilmentprocess-spring-testcleanup.xml"));
