 ...
 */
package com.solvia.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SolviaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SolviaFulfilmentProcessConstants.PARENT_PROCESS);
