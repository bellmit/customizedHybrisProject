 ...
 */
package com.solvia.core.constants;

/**
 * Global class for all SolviaCore constants. You can add global constants for your extension into this class.
 */
public final class SolviaCoreConstants extends GeneratedSolviaCoreConstants
{
	public static final String EXTENSIONNAME = "solviacore";


	private SolviaCoreConstants()
	{
		//empty
	}
