...
import com.solvia.constants.SolviasampleaddonConstants;



/**
 * This is the extension manager of the Solviasampleaddon extension.
 */
public class SolviasampleaddonManager extends GeneratedSolviasampleaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SolviasampleaddonManager.class.getName());
	 ...
	 */
	public static SolviasampleaddonManager getInstance()
	{
		return (SolviasampleaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SolviasampleaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolviasampleaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SolviasampleaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SolviasampleaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SolviasampleaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
