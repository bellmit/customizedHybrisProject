...
import com.solvia.test.constants.SolviaTestConstants;
import com.solvia.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SolviaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/solviatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/solviatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/solviatest/import/cstickets.impex");
			...
			importImpexFile(context, "/solviatest/import/csquotes.impex");
		}
	}
}
