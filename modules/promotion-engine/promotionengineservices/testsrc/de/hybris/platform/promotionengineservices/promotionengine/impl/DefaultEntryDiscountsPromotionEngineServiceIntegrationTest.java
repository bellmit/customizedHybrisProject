...
public class DefaultEntryDiscountsPromotionEngineServiceIntegrationTest extends PromotionEngineServiceBaseTest
{
	...
	public void testBasePriceDiscountsRowWithNoPromotionsEvaluated() throws Exception
	{
		...
		final String fileName = legacyRRDMode ? "basePriceWithDiscountRow_rrd" : "basePriceWithDiscountRow";
		final AbstractRuleEngineRuleModel rule = getRuleForFile(fileName + ".drl",
				"/promotionengineservices/test/rules/");
		rule.setCode(fileName);
		rule.setVersion(valueOf(0L));
	...
	public void testBasePriceDiscountsRowWithonePromotionBeEvaluated() throws Exception
	{
		...
		final String fileName = legacyRRDMode ? "basePriceWithDiscountRowAndPromotion_rrd" : "basePriceWithDiscountRowAndPromotion";
		final AbstractRuleEngineRuleModel rule = getRuleForFile(fileName + ".drl",
				"/promotionengineservices/test/rules/");
		rule.setCode(fileName);
		rule.setVersion(valueOf(0L));
