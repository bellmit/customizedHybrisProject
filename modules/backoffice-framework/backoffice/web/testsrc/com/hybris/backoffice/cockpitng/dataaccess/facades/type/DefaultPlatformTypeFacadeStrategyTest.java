...
public class DefaultPlatformTypeFacadeStrategyTest
{
	...
	@Test
	public void shouldWritableOnCreateWhenWritableIsTrueEvenInitialIsFalse() throws Exception{
		AttributeDescriptorModel attributeDescriptorModel = new AttributeDescriptorModel();
		attributeDescriptorModel.setInitial(false);
		attributeDescriptorModel.setWritable(true);

		boolean isisWritableOnCreation= testSubject.isWritableOnCreation(attributeDescriptorModel);
		assertThat(isisWritableOnCreation).isEqualTo(true);
	}

	@Test
	public void shouldWritableOnCreateWhenWritableIsFalseAndInitialIsTrue() throws Exception{
		AttributeDescriptorModel attributeDescriptorModel = new AttributeDescriptorModel();
		attributeDescriptorModel.setInitial(true);
		attributeDescriptorModel.setWritable(false);
	...
	@Test
	public void shouldNotWritableOnCreateWhenWritableIsFalseAndInitialIsFalse() throws Exception{
		AttributeDescriptorModel attributeDescriptorModel = new AttributeDescriptorModel();
		attributeDescriptorModel.setInitial(false);
		attributeDescriptorModel.setWritable(false);

		boolean isisWritableOnCreation= testSubject.isWritableOnCreation(attributeDescriptorModel);
		assertThat(isisWritableOnCreation).isEqualTo(false);
	}
}
