...
describe("GenericEditor -", function() {
    ...
    var RICH_TEXT_FIELD_VALUE = page.constants.CONTENT_FIELD_INVALID_TEXT;
    var RICH_TEXT_FIELD_VALUE_IT = page.constants.CONTENT_FIELD_INVALID_TEXT_IT;
    ...
    describe('form save', function() {
        ...
        it('GIVEN invalid information has been pushed to two languages in a localized field WHEN the form is saved THEN it' +
            ' will display validation errors only on those two languages',
            function() {

                // GIVEN
                genericEditor.actions.selectLocalizedFieldLanguage(RICH_TEXT_FIELD, ENGLISH_TAB);
                genericEditor.actions.setTextFieldValue(RICH_TEXT_FIELD, ENGLISH_TAB, RICH_TEXT_FIELD_VALUE);

                genericEditor.actions.selectLocalizedFieldLanguage(RICH_TEXT_FIELD, ITALIAN_TAB);
                genericEditor.actions.setTextFieldValue(RICH_TEXT_FIELD, ITALIAN_TAB, RICH_TEXT_FIELD_VALUE_IT);

                // WHEN
                genericEditor.actions.submitForm();

                // THEN 
                genericEditor.assertions.fieldHasNoValidationErrorsInLanguage(RICH_TEXT_FIELD, ENGLISH_TAB);
                genericEditor.assertions.fieldHasNoValidationErrorsInLanguage(RICH_TEXT_FIELD, ITALIAN_TAB);
