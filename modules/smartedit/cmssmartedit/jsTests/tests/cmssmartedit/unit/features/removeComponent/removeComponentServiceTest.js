...
describe('test removeComponentService class', function() {
    ...
    var restServiceFactory, removeComponentService, restServiceForRemoveComponent, experienceInterceptor, renderService, sharedDataService, alertService, systemEventService;
    ...
    beforeEach(angular.mock.module('experienceInterceptorModule', function($provide) {
        ...
        alertService.showDanger.and.returnValue();
