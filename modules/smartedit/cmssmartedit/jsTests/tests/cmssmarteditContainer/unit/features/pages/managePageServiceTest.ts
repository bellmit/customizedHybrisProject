...
import {annotationService, pageDeletionEvictionTag, pageRestoredEvictionTag, rarelyChangingContent, Cached, CrossFrameEventService, IAlertService, IBaseCatalog, ICatalogService, IExperience, IPageInfoService, IRestService, IRestServiceFactory, ISharedDataService} from 'smarteditcommons';
...
describe('managePageService', () => {
	...
	const cmsitemsRestService: any = jasmine.createSpyObj('cmsitemsRestService', ['get', 'update', 'delete', 'getById']);
	...
	const catalogService = jasmine.createSpyObj<ICatalogService>('catalogService', ['retrieveUriContext', 'getContentCatalogActiveVersion', 'getContentCatalogActiveVersion', 'getContentCatalogsForSite']);
	const pageOperationsRESTService = jasmine.createSpyObj<IRestService<any>>('pageOperationsRESTService', ["save"]);
	const sharedDataService = jasmine.createSpyObj<ISharedDataService>('sharedDataService', ['get']);
	const catalogVersionRestService = jasmine.createSpyObj<any>(
