...
export class WorkflowService {
	...
	public getTotalNumberOfActiveWorkflowTasks(): number {
		return this.workflowTasksCountSubject.getValue();
	}

    /** 
     * Temporary to not break the getTotalNumberOfActiveWorkflowTasks signature.
     * Since 2105 this function will be removed and signature of getTotalNumberOfActiveWorkflowTasks will return
     * Observable instead of number.
     */
	public getTotalNumberOfActiveWorkflowTasksAsStream(): Observable<number> {
