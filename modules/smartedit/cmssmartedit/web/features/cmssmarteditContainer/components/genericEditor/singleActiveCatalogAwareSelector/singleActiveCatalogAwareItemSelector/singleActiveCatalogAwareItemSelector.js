...
angular.module('singleActiveCatalogAwareItemSelectorModule', ['resourceLocationsModule', 'yLoDashModule'])
    ...
    .controller('SingleActiveCatalogAwareItemSelectorController', function(catalogService, CONTEXT_SITE_ID, SINGLE_CATALOG_AWARE_ITEM_MAPPING, $scope) {
        ...
        $scope.$watch(function() {
            return this.model.productCatalog;
        }.bind(this), function(productCatalog) {
            if (productCatalog !== this.oldProductCatalog) {
                if (typeof this.reset === 'function') {
                    this.reset(true);
                }

                this.oldProductCatalog = productCatalog;
            }
        }.bind(this));
