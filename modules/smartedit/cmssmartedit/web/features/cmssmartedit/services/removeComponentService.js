...
angular.module('removeComponentServiceModule', ['smarteditServicesModule', 'renderServiceModule', 'removeComponentServiceInterfaceModule', 'experienceInterceptorModule', 'functionsModule', 'resourceLocationsModule'])
     ...
     */
    .factory('removeComponentService', function(crossFrameEventService, restServiceFactory, renderService, extend, gatewayProxy, $q, $log, RemoveComponentServiceInterface, experienceInterceptor, systemEventService, componentInfoService, alertService, PAGES_CONTENT_SLOT_COMPONENT_RESOURCE_URI, COMPONENT_REMOVED_EVENT) {
